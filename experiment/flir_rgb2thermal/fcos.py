...
class FCOS(nn.Module):
    ...
    def forward(self, batched_inputs, is_teacher=False, get_data=False, name=""):
        """
        Args:
        ...
        if self.training:
            ...
            return self.losses(gt_classes, gt_shifts_reg_deltas, gt_centerness,
                               box_cls, box_delta, box_center, name=name)
        else:
    ...
    def losses(self, gt_classes, gt_shifts_deltas, gt_centerness,
               pred_class_logits, pred_shift_deltas, pred_quality, name =''):
        """
        Args:
        ...
        return {
            "loss_cls"+name: loss_cls,
            "loss_box_reg"+name: loss_box_reg,
            "loss_quality"+name: loss_quality
        }
