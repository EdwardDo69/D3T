...
from .paths_route import _PREDEFINED_SPLITS_KaistPairedRgb
...
@DATASETS.register()
class KaistPairedRgb(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(KaistPairedRgb, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_KaistPairedRgb["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_KaistPairedRgb["evaluator_type"]["voc"],
    ...
    def get_path_from_id(self, img_id, image_type='visible'):
        img_id = img_id.split('/')
