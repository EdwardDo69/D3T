...
from .paths_route import _PREDEFINED_SPLITS_BDD100K3CLASS
...
# bike ==> bicycle
#CHANGE_LABELS = {'person':'person', 'car':'car', 'bike':'bicycle'}

CLASS_NAMES = ('person', 'car', 'bicycle')

@DATASETS.register()
class Bdd100kDataset3Class(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(Bdd100kDataset3Class, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_BDD100K3CLASS["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_BDD100K3CLASS["evaluator_type"]["voc"],
    ...
    def _load_annotations(self):
        ...
        for fileid in fileids:
            anno_file = os.path.join(dirname, "Annotations", fileid[:-4] + ".xml")
