...
"""
CONVERT_CLASS = {"person": "People",
               "car": "Car",
               "motorcycle": "Motorcycle"}

@DATASETS.register()
class CityDataset3Class(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(CityDataset3Class, self).__init__(cfg, dataset_name, transforms, is_train)
    ...
    def _load_annotations(self):
        ...
        for fileid in fileids:
            ...
            for obj in tree.findall("object"):
                ...
                if cls not in CONVERT_CLASS.keys():
                    continue
                else:
