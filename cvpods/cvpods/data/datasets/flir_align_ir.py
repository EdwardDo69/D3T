...
from .paths_route import _PREDEFINED_SPLITS_FlIR_ALIGN_IR
...
@DATASETS.register()
class FlirAlignIr(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(FlirAlignIr, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_FlIR_ALIGN_IR["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_FlIR_ALIGN_IR["evaluator_type"]["voc"],
